...
* Create the front-end (visuals) for home page, reservation form, and reservation views. Melinda / Josh

* Create a basic server using Express.JS - Cyrus

* Create a few array variables that will hold the data - Kate

* Create a set of routes for getting and posting table data -  Cyrus

* Create a set of routes for displaying the HTML pages - Cyrus

* Use jQuery to run AJAX calls to GET and POST data from users to the Express server - Kevin
